...
const ICON_PATH_MAPPING: Record<EInteractableIcons, ReactElement> = {
  [EInteractableIcons.MEDIUM]: (
...
const ICON_VIEW_BOX_MAPPING: Record<EInteractableIcons, string> = {
  [EInteractableIcons.MEDIUM]: "0 0 640 512",
  [EInteractableIcons.LINKEDIN]: "0 0 448 512",
  [EInteractableIcons.WEBSITE]: "0 0 640 512",
  [EInteractableIcons.GITHUB]: "0 0 496 512",
};
...
const LogoRedirect: React.FC<LogoRedirectProps> = ({
  ...
  return (
    <svg
      ...
      height="1em"
      viewBox={ICON_VIEW_BOX_MAPPING[icon]}
      style={{ width: width, height: height }}
      className={classes.logo}
      onClick={() => window.open(url, "_blank")}
    >
      {ICON_PATH_MAPPING[icon]}
    </svg>
  );
};
